...
To adjust the layout of the bar chart, we need to use a different plotting function — 
...
Please note that we should call this function AFTER plotting all necessary data onto the figure.
