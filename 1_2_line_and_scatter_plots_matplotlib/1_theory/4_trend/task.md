...
But matplotlib doesn't do additional preprocessing, 
...
<div class="hint" title="How should I aggregate the data?">
   ...
   <li>Using the mean for the <code>critic_score</code> column</li>
   <li>Reset the index to convert a series to a dataframe.</li>
   </ol>
    
   If you have some difficulties with your own aggregation, you can
   have [a sneak to the inner file](file://1_2_line_and_scatter_plots_matplotlib/1_theory/4_trend/data.py)
