...
In simple words, it tries to build a line between our data points in such a way that the mean error was minimized.
...
Previously we only plot one trace, but what if we want to build a scatter plot along with a line?
...
<div class="hint" title="How should I aggregate the data?">
   ...
   <ol>
      <li>Calculate regression line coefficients using <a href="https://numpy.org/doc/stable/reference/generated/numpy.polyfit"><code>polyfit</code></a>. Degree of the fitting polynomial should be 1.</li>
   ...
   have [a sneak to the inner file](file://1_2_line_and_scatter_plots_matplotlib/1_theory/5_regression_plot/data.py)
