...
Use the hidden `filter_by_global_sales` function to get the dataset, including only games with global sales below the 95th
percentile, and pass it to the `hist` function.

Please note, that you don't have to set a logarithmic scale for this task. Also, keep the default number of bins.
