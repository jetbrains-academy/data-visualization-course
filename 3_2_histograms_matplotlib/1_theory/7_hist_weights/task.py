...
from data import filter_by_publisher, filter_by_global_sales, get_weights, preprocess, read
...
def plot(games: pd.DataFrame) -> plt.Figure:
    ...
    for publisher in ["Electronic Arts", "Ubisoft"]:
        ...
        ax.hist(data=filtered_games, x="global_sales", alpha=0.7, weights=get_weights(filtered_games))
