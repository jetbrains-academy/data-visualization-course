...
The organizers of a tasting event received all the responses and now they want us to help with plotting the data.
Let's help them!
...
<div class="hint" title="Which bar chart type should I use?">
    As we need to plot the distribution of votes, the best choice is to use <a href="https://seaborn.pydata.org/generated/seaborn.catplot.html">count plot</a>: 
