...
And then use the hidden `filter_by_global_sales` function to filter out global sales above the 95th percentile.
...
<div class="hint" title="How should I filter the data?">
    ...
    you can use boolean indexing and <a href="https://pandas.pydata.org/docs/reference/api/pandas.Series.isin.html#pandas.Series.isin"><code>isin</code></a> function on <code>publisher</code> column.
</div>
